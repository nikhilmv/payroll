            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form name="form" id="addUser" action="<?php echo base_url() ?>User/addNewMembers" method="post" >
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
							...
							<div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="designation" value="<?php echo set_value('designation'); ?>" name="designation" maxlength="128">
                                    </div>
                                </div>    
                            </div>
							...
							<div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
									<input type="hidden" value="5" id="role" name="role">
