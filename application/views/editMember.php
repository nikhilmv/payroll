            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>User/editMemberDetails" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
								...
								<div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="designation" placeholder="Designation" name="designation" value="<?php echo $designation; ?>" maxlength="128">
                                        <input type="hidden" value="<?php echo $userId; ?>" name="userId" id="userId" />    
                                    </div>
