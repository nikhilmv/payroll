...
class JobCategories_model extends CI_Model
{
    ...
    function JobCategoriesListingCount($searchText = '')

    {
     ...
     function JobCategoriesListing($searchText = '', $page, $segment)
	...
	function getJobCategoryListingInfo($id)
    {
